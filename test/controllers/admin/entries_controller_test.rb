...
class Admin::EntriesControllerTest < ActionController::TestCase
  ...
  test "should create admin_entry" do
    assert_difference('Admin::Entry.count') do
      post :create, admin_entry: { category_id: @admin_entry.category_id, description: @admin_entry.description, title: @admin_entry.title, url: @admin_entry.url }
    end
  ...
  test "should update admin_entry" do
    patch :update, id: @admin_entry, admin_entry: { category_id: @admin_entry.category_id, description: @admin_entry.description, title: @admin_entry.title, url: @admin_entry.url }
    assert_redirected_to admin_entry_path(assigns(:admin_entry))
  end
